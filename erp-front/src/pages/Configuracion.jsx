...
function Configuracion() {
    ...
    return(
        <div>
        <div class="section-heading"><div><h2>Configuración</h2><span class="desc">Preferencias generales del sistema</span></div></div>
        <div class="placeholder-panel">
          ...
          <p>Aquí se administrarán los depósitos, categorías, umbrales de stock mínimo y preferencias generales del sistema de inventario.</p>
        </div>
        </div>
    );
}
